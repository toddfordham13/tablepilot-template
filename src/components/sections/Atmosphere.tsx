        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-3 text-sm sm:text-base text-[#1f1f1f]/70 leading-relaxed max-w-xl">
              Graze Lounge is designed for laid-back evenings that build into late-night
              energy — crafted cocktails, great music, and a space that feels effortless
              from the first drink to the last.
            </p>

            <div className="mt-7 sm:mt-8 grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-4">
              <Feature title="Sunset Starts" desc="Golden-hour drinks and easy conversation." />
              <Feature title="Late-Night Rhythm" desc="Music-led atmosphere that builds." />
              <Feature title="Central Ayia Napa" desc="Right in the heart of the action." />
            </div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl ring-1 ring-[#d9d9d9]/70 shadow-[0_18px_55px_rgba(0,0,0,0.12)]">
